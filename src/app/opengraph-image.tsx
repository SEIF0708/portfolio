...
export const alt = "Saif Ben Abdallah — Technology & Business Development";
  ...
  return new ImageResponse(
    (
      <div style={{ width: "100%", height: "100%", background: "#07090a", color: "#e6ede8", display: "flex", flexDirection: "column", justifyContent: "center", padding: 80, fontFamily: "monospace", border: "2px solid #1c2622" }}>
        <div style={{ color: "#3dff9a", fontSize: 30 }}>~/saif $ whoami</div>
        <div style={{ fontSize: 88, fontWeight: 700, marginTop: 24 }}>SAIF BEN ABDALLAH</div>
